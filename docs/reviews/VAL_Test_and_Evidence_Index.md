...
**Measured latency and cost on the partner route (12.12, 12.13):** an ordinary turn costs about $0.04 and answers in about 7.5 s wall; a consequential turn cost $0.156 and took 68 s wall, of which the blind call was 19.9 s (truncated) and the response 44.6 s for 2,657 output tokens. The earlier Haiku-served figures were not comparable work and are not restated here.
