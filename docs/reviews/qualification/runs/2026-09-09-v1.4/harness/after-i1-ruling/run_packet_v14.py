"""Run the frozen packet v1.4 (persona v1.3) for one exact configuration (high | medium | low on opus-5).
...
from corpus_v14 import ACCESS, CONSEQUENTIAL, INSTRUCTION, L1_QUESTION, O10_HISTORY, ORDINARY, TRAPS, long_note
...
CONFIGURATION["persona_note"] = "scratch-store row seeded from docs/baselines/03-persona.md; identical by digest to the live revision 2 (id 01a087c2-f620-7061-9b4a-730eb45c503b)"
assert _p.semantic_version == "1.3", _p.semantic_version
...
results = {"configuration": CONFIGURATION, "corpus": "v1.4", "started": time.strftime("%Y-%m-%d %H:%M:%S"), "prompts": {}}
