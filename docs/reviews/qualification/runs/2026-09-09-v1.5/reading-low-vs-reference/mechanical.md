...
|---|---|---|
| I1 | {'pass': True, 'note': '18 words'} | {'pass': True, 'note': '16 words'} |
...
Cost (US$, whole run of 36 prompts): this run 2.5245 (every call from the store); reference run 2.7733 (every call from the store)
Wall time: this run ordinary median 4.8 s, max 36.7 s; consequential median 19.4 s, max 25.4 s; long-context 5.1 s; reference run ordinary median 5.5 s, max 61.1 s; consequential median 29.9 s, max 45.0 s; long-context 16.3 s
