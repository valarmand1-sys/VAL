"""Run the frozen packet v1.5 (persona v1.4) for one exact configuration (high | medium | low on opus-5).
...
from corpus_v15 import ACCESS, CONSEQUENTIAL, INSTRUCTION, L1_QUESTION, O10_HISTORY, ORDINARY, TRAPS, long_note
...
results = {"configuration": CONFIGURATION, "corpus": "v1.5", "started": time.strftime("%Y-%m-%d %H:%M:%S"), "prompts": {}}
