"""Run the frozen packet v1.6 (persona v1.4, record-state contract) for one exact configuration (high | medium | low on opus-5).
...
CONFIGURATION["persona_note"] = "scratch-store row seeded from docs/baselines/03-persona.md; identical by digest to the live revision 3 (id 01a08877-dbee-7652-937d-12c36ca4d15c)"
assert _p.semantic_version == "1.4", _p.semantic_version
assert _p.source_sha256 == "10c59951789b7167a0df70e2fe738e41ab2a5a760105983eefc970b6c6e0d9c0", _p.source_sha256
...
results = {"configuration": CONFIGURATION, "corpus": "v1.6", "started": time.strftime("%Y-%m-%d %H:%M:%S"), "prompts": {}}
